 <div class="slider">
      <div class="iconssocial">
        <p>Follow us on</p>
        <nav class="social">
            @if(contactinfo()->facebok ?? ''  != '')
            <a class="icon-facebook" href="{{ contactinfo()->facebok ?? 'facebok' }}" target="_blank" title="Facebook">
            ...
            <a class="icon-twitter" href="{{ contactinfo()->twitter ?? 'twitter' }}" target="_blank" title="Twitter">
            ...
            <a class="icon-instagram" href="{{ contactinfo()->instagram ?? 'instagram' }}" target="_blank" title="Instagram">
            ...
            <a class="icon-youtube" href="{{ contactinfo()->youtube ?? 'youtube' }}" target="_blank" title="youtube">
            ...
            <a class="icon-linkedin" href="{{ contactinfo()->linkedin ?? 'linkedin' }}" target="_blank" title="linkedin">
            ...
            <a class="icon-whatsapp" href="{{ contactinfo()->whatsapp ?? 'whatsapp' }}" target="_blank" title="whatsapp">
                <svg width="20" height="20" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
      ...
      <div class="carousel slide carousel-fade" id="carouselExampleFade" data-ride="carousel">
        <div class="carousel-inner">
          ...
          @foreach ($sliders as $index=>$slider)
           <div class="carousel-item {{ $index === 0 ? "active" : "" }}">    <img src="{{ asset('assets/images/'.$slider->image) }}" alt="{{ $slider->title}} ">
            <div class="container cen-text">
              <div>
                <p class="text"> {{ Str::words($slider->title , 10)  }} </p>
                <h2 class="title"> {{ Str::words($slider->top_header , 5 ,'')  }} <br>  {{ Str::words($slider->buttom_header , 5,'')  }} </h2><a class="bottom" href="{{ url( $slider->linkto ) }}"><span>{{ Str::words($slider->goto , 2,'')  }}</span></a>
              </div>
            </div>
          </div>
          @endforeach
