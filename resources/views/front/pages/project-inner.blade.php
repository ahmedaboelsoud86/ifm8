...
<section class="map-back"><img src="{{ asset('assets/images/slider/img1.jpg') }}" alt="">
      ...
      <div class="row">
        ...
        <div class="col-sm-6 item">
          <div>
            ...
            <p>We seek to manage, operate and maintain the facilities and projects assigned to us by ministries, government agencies and the private sector through the use of a trained technical staff and competent employees with professionalism and high quality, with a focus on gaining the trust of our customers, employees and society and through effective performance of sustainable facilities capable of development and growth.<br><br>Contact our specialist team today:</p><a class="bottom" href="#"><span>Download</span></a>
          </div>
        </div>
      </div>
    </div>
  ...
  <section class="faqs">
    <div class="container">
      <h2 class="title text-center">End-to-end delivery</h2>
      <p class="text-center mt-3"> Whatever your organisation’s energy requirements, Rock Power Connections can deliver the <br>appropriate solution. From providing additional power to your premises, to implementing new </p>
      <div class="accordion mt-5" id="accordionExample">
        <div class="option">
          <div class="click-title" id="headingOne"><a class="d-block position-relative collapsible-link" href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne"> What contracts are available for cleaners?</a></div>
        ...
        <div class="option">
          <div class="click-title" id="headingTwo"><a class="d-block position-relative collapsible-link" href="#" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">  I have a shop. Do you provide a cleaner?</a></div>
          <div class="collapse" id="collapseTwo" aria-labelledby="headingTwo" data-parent="#accordionExample">
            <p class="text">   Integrated facilities was established to manage, operate, and maintain government facilities, companies, and private and public establishments. It began in 1976 with more than 45 years of experience, not only providing cleaning and environmental care services, but also including all utility services to achieve the partners’ goals through a trained team under the management and supervision of experts applying proven methodologies and the latest innovative technologies. To provide the best comprehensive solutions and services</p>
          </div>
        </div>
        <div class="option">
          <div class="click-title" id="headingThree"><a class="d-block position-relative collapsible-link" href="#" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Do the contracts include the worker’s housing or without housing?</a></div>
          <div class="collapse" id="collapseThree" aria-labelledby="headingThree" data-parent="#accordionExample">
            <p class="text">   Integrated facilities was established to manage, operate, and maintain government facilities, companies, and private and public establishments. It began in 1976 with more than 45 years of experience, not only providing cleaning and environmental care services, but also including all utility services to achieve the partners’ goals through a trained team under the management and supervision of experts applying proven methodologies and the latest innovative technologies. To provide the best comprehensive solutions and services</p>
          </div>
        </div>
        <div class="option">
          <div class="click-title" id="headingFor"><a class="d-block position-relative collapsible-link" href="#" data-toggle="collapse" data-target="#collapseFor" aria-expanded="false" aria-controls="collapseFor"> I have a farm. Do you provide workers?</a></div>
          <div class="collapse" id="collapseFor" aria-labelledby="headingFor" data-parent="#accordionExample">
            <p class="text">   Integrated facilities was established to manage, operate, and maintain government facilities, companies, and private and public establishments. It began in 1976 with more than 45 years of experience, not only providing cleaning and environmental care services, but also including all utility services to achieve the partners’ goals through a trained team under the management and supervision of experts applying proven methodologies and the latest innovative technologies. To provide the best comprehensive solutions and services</p>
          </div>
        </div>
      </div>
  ...
  <section class="teams">
    <div class="container"><span class="tag text-center mb-2">Our Expert Staff</span>
    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-5 item">
          ...
          <p>If you’re looking for more information, need to talk to someone about an enquiry or want to chat about your service needs, then you’ve come to the right place. <br><br> Please fill in our short form and a member of our team will be in touch.<br><br>If you have a supplier enquiry, please visit our dedicated portal on <a href="mailto:info@ifm.com.sa">info@ifm.com.sa</a></p>
        </div>
