    ...
    <section class="map-back"><img src="{{ asset('assets/images/slider/img1.jpg') }}" alt="">
        <div class="container">
            ...
            <ul class="maplink">
                ...
                <li>The Contracting Group honored </li>
            </ul>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-9 itemnews">
                    <div class="photo"><img src="{{ asset('assets/images/slider/img2.jpg') }}" alt=""></div><span class="date">
                        <svg width="19" height="18" viewBox="0 0 19 18" fill="none"
                            xmlns="http://www.w3.org/2000/svg">
                            <path
                                d="M1.37504 14.8008H4.01176V16.3828C4.01176 16.674 4.24787 16.9101 4.5391 16.9101H18.3203C18.6116 16.9101 18.8477 16.674 18.8477 16.3828V2.67187C18.8477 2.38064 18.6116 2.14453 18.3203 2.14453H15.6836V1.61719C15.6836 1.32595 15.4475 1.08984 15.1563 1.08984C14.865 1.08984 14.6289 1.32595 14.6289 1.61719V2.14453H11.9571V1.61719C11.9571 1.32595 11.7209 1.08984 11.4297 1.08984C11.1385 1.08984 10.9024 1.32595 10.9024 1.61719V2.14453H8.26565V1.61719C8.26565 1.32595 8.02955 1.08984 7.73831 1.08984C7.44708 1.08984 7.21097 1.32595 7.21097 1.61719V2.14453H4.5391C4.24787 2.14453 4.01176 2.38064 4.01176 2.67187V5.83593C4.01176 9.72244 2.39651 12.7123 1.03744 13.8683C0.86686 14.0104 0.803614 14.2442 0.879165 14.453C0.954786 14.6617 1.153 14.8008 1.37504 14.8008ZM17.793 15.8554H5.06644V14.8008H15.1563C15.2796 14.8008 15.3991 14.7575 15.4939 14.6785C16.1278 14.1505 17.1098 12.8934 17.793 11.2833V15.8554ZM5.06644 3.19921H7.21097V3.72656C7.21097 4.01779 7.44708 4.2539 7.73831 4.2539C8.02955 4.2539 8.26565 4.01779 8.26565 3.72656V3.19921H10.9024V3.72656C10.9024 4.01779 11.1385 4.2539 11.4297 4.2539C11.7209 4.2539 11.9571 4.01779 11.9571 3.72656V3.19921H14.6289V3.72656C14.6289 4.01779 14.865 4.2539 15.1563 4.2539C15.4475 4.2539 15.6836 4.01779 15.6836 3.72656V3.19921H17.793V5.30859H5.06644V3.19921ZM5.05741 6.36292H17.7836C17.6648 9.70821 16.3809 12.3403 14.9495 13.7461H2.57454C4.1964 11.6796 4.9704 8.9888 5.05741 6.36292Z"
                                fill="#0f9fdc"></path>
                            <clipPath id="clip0_41_4510">
                                <rect width="18" height="18" fill="white" transform="translate(0.847656)"></rect>
                            </clipPath>
                        </svg>12.03.2024</span>
                    <h3 class="title">The Contracting Group Honored</h3>
                    <p class="text"> Integrated facilities was established to manage, operate, and maintain government
                        facilities, companies, and private and public establishments. It began in 1976 with more than 45
                        years of experience, not only providing cleaning and environmental care services Integrated
                        facilities was established to manage, operate, and maintain government facilities, companies, and
                        private and public establishments. It began in 1976 with more than 45 years of experience, not only
                        providing cleaning and environmental care services <br><br>Integrated facilities was established to
                        manage, operate, and maintain government facilities, companies, and private and public
                        establishments. It began in 1976 with more than 45 years of experience, not only providing cleaning
                        and environmental care services <br><br>Integrated facilities was established to manage, operate,
                        and maintain government facilities, companies, and private and public establishments. It began in
                        1976 with more than 45 years of experience, not only providing cleaning and environmental care
                        services </p>
                ...
                <div class="col-sm-3 itemnews hidebox">
                    ...
                    <div class="archives">
                        ...
                        <nav class="list"> <a href="news-inner.html">
                                ...
                                </svg>The Contracting Group Honored</a><a href="news-inner.html">
                                <svg viewBox="0 0 10 6" xmlns="http://www.w3.org/2000/svg">
                                    <path
                                        d="M5.27438 5.58083L9.89199 0.963231C10.0396 0.810363 10.0354 0.566767 9.88252 0.41913C9.73339 0.2751 9.49699 0.2751 9.34789 0.41913L5.00233 4.76468L0.656779 0.41913C0.506526 0.2689 0.262929 0.2689 0.112677 0.41913C-0.0375528 0.569405 -0.0375529 0.812978 0.112677 0.963231L4.73028 5.58083C4.88056 5.73106 5.12413 5.73106 5.27438 5.58083Z">
                                    </path>
                    ...
                    <div class="most ">
                        ...
                        <div class="other"><a class="photo" href="news-inner.html"><img src="{{ asset('assets/images/n-1.jpg') }}"
                                    alt="" title=""></a><a class="link" href="news-inner.html">The
                                Contracting Group Honored</a></div>
                        <div class="other"><a class="photo" href="news-inner.html"><img src="{{ asset('assets/images/n-1.jpg') }}"
                                    alt="" title=""></a><a class="link" href="news-inner.html">The
                                Contracting Group Honored</a></div>
                        <div class="other"><a class="photo" href="news-inner.html"><img src="{{ asset('assets/images/n-1.jpg') }}"
                    ...
                    <div class="tags ">
                        ...
                        <nav class="list"> <a href="news-inner.html">news</a><a href="news-inner.html">escort</a><a
                                href="news-inner.html">news</a><a href="news-inner.html">escort</a><a
                                href="news-inner.html">news</a><a href="news-inner.html">escort</a>
                        </nav>
                    </div>
                </div>
            </div>
