        ...
        <div class="row">
          <div class="col-sm-9 itemnews">
            <div class="photo"><img src="{{ asset('assets/images/'.$article->image) }}" alt="{{ $article->title }}"></div><span class="date">
              ...
              </svg> {{ \Carbon\Carbon::parse($article->created_at)->format('d.m.Y')}}</span>
            <h3 class="title"> {{ $article->title }}</h3>
            <p class="text">{{ $article->description }} </p>
            <div class="shareicons">
              <p>@lang('site.share'):</p>
              <nav class="social"><a class="icon-facebook" href="{{ $links['facebook'] }}" target="_blank" title="Facebook">
                  <svg id="Bold" enable-background="new 0 0 24 24" height="512" viewBox="0 0 24 24" width="512" xmlns="http://www.w3.org/2000/svg">
                    <path d="m15.997 3.985h2.191v-3.816c-.378-.052-1.678-.169-3.192-.169-3.159 0-5.323 1.987-5.323 5.639v3.361h-3.486v4.266h3.486v10.734h4.274v-10.733h3.345l.531-4.266h-3.877v-2.939c.001-1.233.333-2.077 2.051-2.077z"></path>
                  </svg></a><a class="icon-twitter" href="{{ $links['twitter'] }}" target="_blank" title="Twitter">
                  ...
                  </svg></a><a class="icon-whatsapp" href="{{ $links['whatsapp'] }}" target="_blank" title="whatsapp">
          ...
          <div class="col-sm-3 itemnews hidebox">
            ...
            <div class="most ">
              ...
              <div class="other">
               <a class="photo" href="{{ route('news-inner',[$item->id,str_replace(' ','-',$item->translate()->title ?? '' )])}}">
                    <img src="{{ asset('assets/images/'.$item->image ) }}" alt="" title="">
                </a>
