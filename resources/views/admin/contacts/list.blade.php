                ...
                <table class="table table-striped table-bordered table-hover" id="sample_2">
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>  {{ $item->subject }} </td>
                            <td class="center">
                                <form action="{{ route('messages.destroy',$item->id) }}" style="display:inline;" method="POST">
                                    @csrf
                                    @method('DELETE')
                                    ...
                                    <a href="{{ route('messages.show',$item->id) }}" title="show" class="btn default btn-xs purple">
