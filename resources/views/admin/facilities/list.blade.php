    ...
    <div class="col-md-12  col-sm-12">
        ...
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                <div class="caption">
                    <i class="fa fa-user"></i>Facilities
                </div>
                <div class="actions">
                    <a href="{{ route('facilities.create') }}" class="btn btn-default btn-sm ">Add New Facility</a>
                </div>
            </div>
                ...
                <table class="table table-striped table-bordered table-hover" id="sample_2">
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td>  {{ $index +1 }} </td>
                            <td>  {{ $item->category->translate('en')->title ?? '' }} </td>
                            <td>  <img class="img-thumbnail" width="150" src="{{ asset('assets/images/'.$item->image) }}" ></td>
                            <td>  <img  width="100" src="{{ asset('assets/images/'.$item->icon) }}" > </td>
                            ...
                            <td class="center">
                                ...
                                <form action="{{ route('facilities.destroy',$item->id) }}" style="display:inline;" method="POST">
                                @csrf
                                @method('DELETE')
                                ...
                                <a href="{{ route('facilities.edit',$item->id) }}" title="update" class="btn default btn-xs purple">
