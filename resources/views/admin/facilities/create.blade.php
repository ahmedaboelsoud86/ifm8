                ...
                <div class="form-body">
                    <div class="form-group">
                        ...
                        {{ csrf_field() }}
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group form-group{{ $errors->has('category_id') ? ' has-error' : '' }}" >
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group form-group{{ $errors->has('icon') ? ' has-error' : '' }}" >
                                        <label class="control-label">Icon <span style="color: red"> *  ( only SVG  )</span> </label>
                                        <input type="file" autocomplete="off" required accept=".svg" value="{{ old('icon') }}"   name="icon" class="form-control">
                                    </div>
                                </div>
