    ...
    <div class="col-md-12  col-sm-12">
        ...
        <div class="portlet box blue-hoki">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a href="{{ route('categories.create') }}" class="btn btn-default btn-sm ">Add New Category</a>
                </div>
            </div>
                    ...
                    <tbody>
                        ...
                        <tr class="odd gradeX">
                            ...
                            <td class="center">
                                ...
                                <form action="{{ route('categories.destroy',$item->id) }}" style="display:inline;" method="POST">
                                @csrf
                                @method('DELETE')
                                ...
                                <a href="{{ route('categories.edit',$item->id) }}" title="update" class="btn default btn-xs purple">
