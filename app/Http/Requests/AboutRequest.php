...
class AboutRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        if (in_array($this->method(), ['PUT', 'PATCH'])) {
            ...
            //$rules += ['frist_image' => ['image','dimensions:min_width=600,min_height=600']];
            //$rules += ['second_image' => ['image','dimensions:min_width=600,min_height=600']];
        ...
        foreach (config('translatable.locales') as $locale) {
            ...
            //$rules += ['frist_image' => ['required','image','dimensions:min_width=600,min_height=600']];
            //$rules += ['second_image' => ['required','image','dimensions:min_width=600,min_height=600']];
